...
[![Typing SVG](https://readme-typing-svg.demolab.com?font=Fira+Code&weight=600&size=28&pause=1000&color=9575CD&center=true&vCenter=true&width=700&lines=Hi+there%2C+I'm+Aya+Alharazin+%F0%9F%91%8B;CS+Graduate+%7C+Teaching+Assistant;Data+Science+%7C+Python+%7C+SQL;Tech+for+Social+Impact+%F0%9F%8C%8D)](https://git.io/typing-svg)

<img src="https://capsule-render.vercel.app/api?type=waving&height=200&text=Aya+Alharazin&fontAlign=50&fontAlignY=40&color=9575CD&fontColor=ffffff" />
...
I'm a **Computer Science graduate** from Gaza, Palestine 🇵🇸 with a **GPA of 95.71/100**, passionate about using technology and data to create meaningful change.
...
- 🎓 **Education** — Teaching Python, Java, Data Structures & OS to university students
- 📊 **Data Science** — NumPy, Pandas, and data analysis for humanitarian applications
- 🌍 **Social Impact** — Tech solutions addressing real-world challenges in Gaza and beyond
...
![PartyRock](https://img.shields.io/badge/-PartyRock-9575CD?style=flat-square&logo=amazonaws&logoColor=white)
...
```
CS Graduate @ IUG (GPA: 95.71/100)
           ↓
   Teaching Assistant @ IUG
           ↓
...
> **Goal:** Leverage data science to create evidence-based solutions for humanitarian challenges while continuing to educate and inspire the next generation of developers.
